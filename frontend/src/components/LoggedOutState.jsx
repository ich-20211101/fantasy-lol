...
export default function LoggedOutState() {
  ...
  return (
    <main className="logged-out-page">
      <section className="logged-out-frame">
        <Header variant="logo" />

        <div className="logged-out-scroll">
          <div className="logged-out-message">
            <span>{t('common.loginRequired')}</span>
          </div>

          <div className="logged-out-cta">
            <button type="button" className="logged-out-google-btn" onClick={loginWithGoogle}>
